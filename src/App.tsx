      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="bg-white border-4 border-black shadow-[8px_8px_0px_black] w-[320px] mb-4 overflow-hidden flex flex-col h-[450px]"
          >
            ...
            <div className="flex-grow overflow-y-auto p-4 space-y-4 bg-gray-50">
              {messages.map((m, i) => (
                <div key={i} className={`flex ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[80%] p-3 border-2 border-black font-semibold text-sm shadow-[2px_2px_0px_black] ${
              ...
              <div className="flex flex-wrap gap-2">
                {options.map((opt, i) => (
                  <button 
                    ...
                    className="text-[10px] font-bold border-2 border-black px-2 py-1 hover:bg-[#65c962] transition-colors"
                  >
                    {opt.q}
                  </button>
                ))}
      ...
      <nav className="flex justify-between items-center px-[5%] py-4 md:py-5 bg-white border-b-3 border-black sticky top-0 z-[1000]">
        ...
        <div className="flex items-center gap-3 md:gap-5 md:mt-0">
          ...
          <motion.a 
            whileTap={{ scale: 0.95 }}
            href="#iscriviti" 
            className="bg-black text-white px-2 py-1.5 md:px-4 md:py-2 border-2 border-black font-bold uppercase text-[10px] md:text-sm hover:bg-[#65c962] hover:text-black transition-all"
          >
            Iscriviti Ora
          </motion.a>
        </div>
      ...
      <header className="grid md:grid-cols-2 items-center gap-12 max-w-7xl mx-auto mt-8 md:mt-16 px-[5%] overflow-hidden">
        ...
        >
          <h1 className="font-syne text-5xl md:text-7xl font-bold leading-[0.9] uppercase">
            Vivi meglio<br />ogni <span className="bg-[#65c962] px-2 shadow-[4px_4px_0px_black]">giorno.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <motion.a 
              whileTap={{ scale: 0.95 }}
              href="#iscriviti" 
              className="bg-black text-white px-8 py-4 font-bold uppercase shadow-[6px_6px_0px_black] hover:bg-[#65c962] hover:text-black hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all"
            >
              Voglio iscrivermi!
            </motion.a>
            <motion.button 
      ...
      <section className="bg-[#effaf0] py-24 px-[5%] border-y-3 border-black overflow-hidden">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white border-3 border-black p-8 shadow-[8px_8px_0px_black]"
          >
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-black text-white border-3 border-black p-10 shadow-[6px_6px_0px_black]"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.2 }}
            className="bg-white border-3 border-black p-10 shadow-[6px_6px_0px_black]"
          >
          ...
          {subStatus ? (
            ...
            <form onSubmit={handleSubscribe} className="space-y-4">
              <input 
                ...
                required 
                disabled={submitting}
                className="w-full p-4 border-2 border-black bg-gray-50 font-semibold focus:outline-none focus:bg-[#65c962] transition-all disabled:opacity-50" 
              />
              <div className="flex items-center gap-3 py-2">
                <input 
                  ...
                  className="w-5 h-5 border-2 border-black accent-[#65c962]"
                />
              ...
              <motion.button 
                ...
                type="submit" 
                disabled={submitting}
                className="w-full bg-black text-white py-4 font-bold text-xl uppercase hover:bg-[#65c962] hover:text-black transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
      ...
      <div className="min-h-screen bg-white text-[#121212] font-inter">
        ...
        <article className="max-w-3xl mx-auto py-16 px-[5%]">
          <img 
            ...
            className="w-full border-3 border-black shadow-[8px_8px_0px_black] mb-12 bg-gray-100" 
            referrerPolicy="no-referrer"
            onError={(e) => {
              (e.target as HTMLImageElement).src = DEFAULT_IMAGE;
            }}
          ...
          <div className="mt-20 pt-12 border-t-4 border-black text-center">
            ...
            <motion.button 
              whileTap={{ scale: 0.95 }}
              onClick={() => setView('landing')} 
              className="bg-[#65c962] border-3 border-black px-8 py-4 font-bold uppercase shadow-[6px_6px_0px_black] hover:translate-x-[-2px] hover:translate-y-[-2px] transition-all"
            >
              Iscriviti Ora
            </motion.button>
          </div>
                ...
                <div key={article.id} className="bg-white border-2 border-black p-4 flex justify-between items-center shadow-[4px_4px_0px_black]">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="p-2 border-2 border-black hover:bg-red-100 text-red-600"
                    >
                      <Trash2 size={18} />
                    </button>
                  </div>
